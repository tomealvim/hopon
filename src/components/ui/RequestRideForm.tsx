  ...
  return (
    <form onSubmit={submit} className="grid gap-4 p-1">
      ...
      <fieldset aria-label="Disponibilidade">
        <legend className="block text-xs font-semibold text-gray-600 mb-1">Disponibilidade</legend>
        <label className="flex items-center gap-2 text-sm text-gray-900">
          <input type="checkbox" className="w-4 h-4 rounded border-gray-300 bg-gray-50" checked={values.disponibilidade.manha} onChange={e=>setDisp("manha", e.target.checked)} />
          Manhã (6h-12h)
        </label>
        <label className="flex items-center gap-2 text-sm text-gray-900">
          <input type="checkbox" className="w-4 h-4 rounded border-gray-300 bg-gray-50" checked={values.disponibilidade.tarde} onChange={e=>setDisp("tarde", e.target.checked)} />
          Tarde (12h-18h)
        </label>
        <label className="flex items-center gap-2 text-sm text-gray-900">
          <input type="checkbox" className="w-4 h-4 rounded border-gray-300 bg-gray-50" checked={values.disponibilidade.noite} onChange={e=>setDisp("noite", e.target.checked)} />
          Noite (18h-24h)
        </label>
      </fieldset>
      ...
      <fieldset aria-label="Preferências">
        ...
        <label className="flex items-center gap-2 text-sm text-gray-900">
          <input type="checkbox" className="w-4 h-4 rounded border-gray-300 bg-gray-50" checked={values.preferencias.musica} onChange={e=>setPref("musica", e.target.checked)} />
          Música
        </label>
        <label className="flex items-center gap-2 text-sm text-gray-900">
          <input type="checkbox" className="w-4 h-4 rounded border-gray-300 bg-gray-50" checked={values.preferencias.falar} onChange={e=>setPref("falar", e.target.checked)} />
          Conversa
        </label>
        <label className="flex items-center gap-2 text-sm text-gray-900">
          <input type="checkbox" className="w-4 h-4 rounded border-gray-300 bg-gray-50" checked={values.preferencias.bagagem} onChange={e=>setPref("bagagem", e.target.checked)} />
          Levo bagagem
        </label>
        <label className="flex items-center gap-2 text-sm text-gray-900">
          <input type="checkbox" className="w-4 h-4 rounded border-gray-300 bg-gray-50" checked={values.preferencias.animais} onChange={e=>setPref("animais", e.target.checked)} />
          Levo animais
        </label>
        <label className="flex items-center gap-2 text-sm text-gray-900">
          <input type="checkbox" className="w-4 h-4 rounded border-gray-300 bg-gray-50" checked={values.preferencias.fumador} onChange={e=>setPref("fumador", e.target.checked)} />
          Sou fumador
        </label>
      </fieldset>

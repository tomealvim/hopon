  ...
  return (
    <div
      className={cn(
        ...
        interactive && "hover:bg-white/12 hover:border-white/25 hover:shadow-xl hover:shadow-pink-500/10 hover:scale-[1.01] transition-all duration-300 active:scale-[0.99]",
        "animate-fade-in-up",
        className
      )}
      {...rest}

  ...
  return (
    ...
    >
      <div className="grid gap-4 p-1">
        ...
        <div>
          <label className="block text-xs font-semibold text-gray-700 mb-2">Motivo</label>
        ...
        <div>
          ...
          <textarea
            className="w-full px-3 py-2.5 border border-gray-200 rounded-xl outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 resize-none text-sm"
            rows={3}

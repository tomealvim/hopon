...
export default function BottomNav({ current, onChange, onPlus }: BottomNavProps) {
  ...
  return (
    <nav
      className="fixed left-0 right-0 bottom-0 z-50 bg-white border-t border-gray-100 shadow-none pb-[env(safe-area-inset-bottom)]"
      role="navigation"
    ...
    >
      <div className="mx-auto max-w-mobile grid grid-cols-[1fr_1fr_auto_1fr_1fr] items-center h-16 px-2 md:max-w-tablet lg:max-w-desktop">
        ...
        {/* FAB central */}
        <button
          className="relative -top-3 h-14 w-14 rounded-full bg-gray-900 text-white inline-flex items-center justify-center hover:bg-gray-700 active:scale-95 transition-all duration-200 focus-visible:outline-2 focus-visible:outline-gray-900 focus-visible:outline-offset-2"

  ...
  return (
    ...
    >
      <div className="grid gap-4">
        ...
        {/* Pesquisa */}
        <div>
          <label className="block text-xs font-semibold text-gray-700 mb-1" htmlFor={`${uid}-q`}>Pesquisar</label>
          <input
            id={`${uid}-q`}
        ...
        <div className="grid grid-cols-3 gap-3">
          ...
          <div>
            <label className="block text-xs font-semibold text-gray-700 mb-1" htmlFor={`${uid}-tol`}>Tolerância (± min)</label>
            <input
              id={`${uid}-tol`} 
              className="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm outline-none focus:border-primary focus:ring-2 focus:ring-primary/20" 
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            <label className="block text-xs font-semibold text-gray-700 mb-1" htmlFor={`${uid}-seats`}>Lugares mínimos</label>
            <input
              id={`${uid}-seats`} 
              className="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm outline-none focus:border-primary focus:ring-2 focus:ring-primary/20" 
          ...
          {/* Ordenação */}
          <div>
            <label className="block text-xs font-semibold text-gray-700 mb-1" htmlFor={`${uid}-sort`}>Ordenar por</label>
            <select
              id={`${uid}-sort`} 
              className="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm outline-none focus:border-primary focus:ring-2 focus:ring-primary/20" 
              title="Ordenação"
        ...
        {showAdvanced && (
          <div id={`${uid}-advanced`} className="grid gap-4 pt-4 border-t border-gray-200">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="block text-xs font-semibold text-gray-700 mb-1" htmlFor={`${uid}-origin`}>Origem</label>
                <input
                  id={`${uid}-origin`} 
                  className="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm outline-none focus:border-primary focus:ring-2 focus:ring-primary/20"
              ...
              <div>
                <label className="block text-xs font-semibold text-gray-700 mb-1" htmlFor={`${uid}-destination`}>Destino</label>
                <input
                  id={`${uid}-destination`} 
                  className="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm outline-none focus:border-primary focus:ring-2 focus:ring-primary/20"
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="block text-xs font-semibold text-gray-700 mb-1" htmlFor={`${uid}-dev`}>Raio de desvio (km)</label>
                <input
                  id={`${uid}-dev`} type="range" min={0} max={10}
                  className="w-full"
                  value={f.deviationKm} onChange={e => update("deviationKm", Number(e.target.value))}
                />
                <div className="text-xs text-gray-500 mt-1">{f.deviationKm} km</div>
              </div>
              <div>
                <label className="block text-xs font-semibold text-gray-700 mb-1" htmlFor={`${uid}-overlap`}>Sobreposição de rota (%)</label>
                <input
                  id={`${uid}-overlap`} type="range" min={0} max={100}
                  className="w-full"
                  value={f.routeOverlapPct} onChange={e => update("routeOverlapPct", Number(e.target.value))}
                />
                <div className="text-xs text-gray-500 mt-1">{f.routeOverlapPct}%</div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-3">
              <div>
                <label className="block text-xs font-semibold text-gray-700 mb-1" htmlFor={`${uid}-bag`}>Bagagem</label>
                <select
                  id={`${uid}-bag`} 
                  className="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm outline-none focus:border-primary focus:ring-2 focus:ring-primary/20" 
              ...
              <div>
                <label className="block text-xs font-semibold text-gray-700 mb-1" htmlFor={`${uid}-vibe`}>Vibe</label>
                <select
                  id={`${uid}-vibe`} 
                  className="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm outline-none focus:border-primary focus:ring-2 focus:ring-primary/20" 
              ...
              <div>
                <label className="block text-xs font-semibold text-gray-700 mb-1" htmlFor={`${uid}-price`}>Contribuição máx. (€)</label>
                <input
                  id={`${uid}-price`} 
                  className="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm outline-none focus:border-primary focus:ring-2 focus:ring-primary/20" 
            ...
            <div className="grid grid-cols-3 gap-3">
              <label className="inline-flex items-center gap-2 cursor-pointer">
                <input type="checkbox" className="w-4 h-4 rounded border-gray-300" checked={f.ac} onChange={e => update("ac", e.target.checked)} />
                <span className="text-sm">Ar condicionado</span>
              </label>
              <label className="inline-flex items-center gap-2 cursor-pointer">
                <input type="checkbox" className="w-4 h-4 rounded border-gray-300" checked={f.music} onChange={e => update("music", e.target.checked)} />
                <span className="text-sm">Música</span>
              </label>
              <label className="inline-flex items-center gap-2 cursor-pointer">
                <input type="checkbox" className="w-4 h-4 rounded border-gray-300" checked={f.backSeatsFree} onChange={e => update("backSeatsFree", e.target.checked)} />
                <span className="text-sm">Bancos traseiros livres</span>
              </label>
            </div>
            ...
            <div className="grid grid-cols-3 gap-3">
              <div>
                <label className="block text-xs font-semibold text-gray-700 mb-1" htmlFor={`${uid}-rating`}>Avaliação mínima</label>
                <input
                  id={`${uid}-rating`} type="range" min={3.5} max={5} step={0.1}
                  className="w-full"
                  value={f.minRating} onChange={e => update("minRating", Number(e.target.value))}
                />
                <div className="text-xs text-gray-500 mt-1">{f.minRating.toFixed(1)} ★</div>
              </div>
              <div>
                <label className="block text-xs font-semibold text-gray-700 mb-1" htmlFor={`${uid}-punct`}>Pontualidade</label>
                <select
                  id={`${uid}-punct`} 
                  className="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm outline-none focus:border-primary focus:ring-2 focus:ring-primary/20" 
              ...
              <div>
                <label className="block text-xs font-semibold text-gray-700 mb-1">Preferências</label>
                <label className="inline-flex items-center gap-2 cursor-pointer mb-2">
                  <input type="checkbox" className="w-4 h-4 rounded border-gray-300" checked={f.frequent} onChange={e => update("frequent", e.target.checked)} />
                  <span className="text-sm">Condutor frequente</span>
                </label>
                <label className="inline-flex items-center gap-2 cursor-pointer">
                  <input type="checkbox" className="w-4 h-4 rounded border-gray-300" checked={f.accessible} onChange={e => update("accessible", e.target.checked)} />

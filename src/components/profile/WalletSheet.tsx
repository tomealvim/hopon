          ...
          <>
            ...
            <section>
              ...
              <button
                type="button"
                onClick={openAddForm}
                className="mt-4 w-full rounded-2xl border border-dashed border-gray-200 bg-gray-50 px-4 py-3 text-sm font-semibold text-gray-700 hover:border-gray-300 hover:bg-gray-100 transition"
              >
                Adicionar método
              </button>
            </section>
